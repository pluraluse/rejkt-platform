...
- The marketplace adds itself as an FA2 operator on swap, removes on cancel/sold-out.
"""
...
def marketplace_module():
    ...
    # FA2 operator permission — matches fa2_lib layout exactly
    ...
    class REJKTMarketplace(sp.Contract):
        ...
        def collect(self, params):
            ...
            # Track how much mutez is left to distribute.
            # sp.split_tokens(total, num, denom) handles rounding safely.
        ...
        def set_fa2_contract(self, new_fa2):
            """Admin: point marketplace at a new FA2 contract (e.g. after redeploy)."""
...
def test():
    ...
    scenario.verify(fa2.data.ledger[sp.pair(bob.address, sp.nat(0))] == sp.nat(2))
    ...
    scenario.verify(fa2.data.ledger[sp.pair(bob.address, sp.nat(0))] == sp.nat(6))
